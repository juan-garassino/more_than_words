...
# Output: thornfield/trainer/outputs/amber_cipher/model.pt
# -----------------------------------------------------------------------------
...
# Output:   thornfield/trainer/outputs/amber_cipher/policy.pt
# -----------------------------------------------------------------------------
...
ac-pipeline: colab-install
	@echo ""
	@echo "################################################################"
	@echo "  THORNFIELD — AMBER CIPHER FULL PIPELINE  (CPU)"
...
ac-pipeline-gpu: colab-install
	@echo ""
	@echo "################################################################"
	@echo "  THORNFIELD — AMBER CIPHER FULL PIPELINE  (GPU)"
	@echo "################################################################"
	$(MAKE) ac-s01-validate
	$(MAKE) ac-s02-pack
...
# -----------------------------------------------------------------------------
# Stage 03 — Train Hopfield model
# Output: thornfield/trainer/outputs/amber_cipher_M/model.pt
# -----------------------------------------------------------------------------
...
# Stage 04 — Train transformer policy
# Requires: model.pt from stage 03
# Output:   thornfield/trainer/outputs/amber_cipher_M/policy.pt
# -----------------------------------------------------------------------------
...
acm-pipeline: colab-install
	@echo ""
	@echo "################################################################"
	@echo "  THORNFIELD — AMBER CIPHER M FULL PIPELINE  (CPU)"
	@echo "  s01 validate → s02 pack → s03 hopfield → s04 policy → s05 benchmark"
	@echo "################################################################"
...
acm-pipeline-gpu: colab-install
	@echo ""
	@echo "################################################################"
	@echo "  THORNFIELD — AMBER CIPHER M FULL PIPELINE  (GPU)"
	@echo "################################################################"
	$(MAKE) acm-s01-validate
	$(MAKE) acm-s02-pack
