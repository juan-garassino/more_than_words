...
train-amber-cipher: pack-amber-cipher
	KMP_DUPLICATE_LIB_OK=TRUE KMP_USE_SHM=0 OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 PYTHONPATH=thornfield/trainer python3 thornfield/trainer/tools/train_single_case.py amber_cipher --paths 300 --epochs 1
