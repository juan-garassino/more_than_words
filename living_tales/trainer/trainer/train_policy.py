"""
Train a Living Tales transformer policy via supervised pretraining + REINFORCE.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Living Tales transformer policy")
    ...
    _banner(f"LIVING TALES — TRAIN POLICY  ({case_id})")
