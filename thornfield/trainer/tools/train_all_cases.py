    ...
    for cf in case_files:
        ...
        try:
            result = subprocess.run(
                ["python3", str(_ROOT / "thornfield_case_validator.py"), str(cf)],
...
def zip_outputs(case_ids: list[str]) -> str:
    ...
    zip_path = _OUTPUTS / f"thornfield_all_cases_{timestamp}.zip"
...
def main():
    parser = argparse.ArgumentParser(description="Train all valid Thornfield cases.")
    ...
    _banner("THORNFIELD — TRAIN ALL CASES")
